...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/raspy-cloud-aca9)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/raspy-cloud-aca9
```

A live public deployment of this template is available at [https://raspy-cloud-aca9.templates.workers.dev](https://raspy-cloud-aca9.templates.workers.dev)
